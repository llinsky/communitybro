...
extern RecordType* URG_packet;
extern RecordType* PSH_packet;
extern RecordType* CWR_packet;
extern RecordType* ECE_packet;
...
extern StringVal *log_ident;
extern bool reporter_to_syslog;
