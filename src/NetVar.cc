...
RecordType* URG_packet;
RecordType* PSH_packet;
RecordType* CWR_packet;
RecordType* ECE_packet;
...
#include "reporter.bif.netvar_init"
	...
	URG_packet = internal_type("URG_packet")->AsRecordType();
	PSH_packet = internal_type("PSH_packet")->AsRecordType();
	CWR_packet = internal_type("CWR_packet")->AsRecordType();
	ECE_packet = internal_type("ECE_packet")->AsRecordType();
	...
	log_facility = opt_internal_int("log_facility");
	log_priority = opt_internal_int("log_priority");
	log_ident = opt_internal_string("log_ident");
	reporter_to_syslog = bool(internal_val("reporter_to_syslog")->AsBool());
	}
