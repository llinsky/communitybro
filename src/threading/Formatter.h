...
public:
	...
	/**
	 * Convert a uint64 into a string. This renders the double with Bro's
	 * standard precision.
	 *
	 * This is a helper function that formatter implementations may use.
	 *
	 * @param d The uint64 value.
	 *
	 * @return An ASCII representation of the uint64.
	 */
	static string Render(uint64 d);
