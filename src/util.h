...
extern std::vector<std::string> split_tokens(const std::string &s, char delim);
...
// These constants and functions are used to determine whether information
// in a UDP or TCP last resort flow is interesting enough to log after the
// initial handshake message(s)
#define MAX_ENTROPY 5 //0-8
#define MIN_ASCII 30.0 //0-100 (percentage)
#define MAX_TCP_EXCERPTS 2
#define MAX_UDP_EXCERPTS 2
